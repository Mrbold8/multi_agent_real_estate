...
# wrap in a parallel block (still only one, but keeps same API)
#Extractor Workflow
...
root_agent = SequentialAgent(
    ...
    # Доор байгааг ашиглаад Tavil Search, Writer agent туршиж болно шүү.
    # sub_agents=[parallel_retrieval_agent, writer]
)